                        ...
                        <table class="table table-striped table-bordered datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="500">Judul</th><th class="text-center" width="500">Pesan</th>
                                ...
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route("admin.option.contact.edit",$row->id) }}" title="Edit">
                                                <i class="glyphicon glyphicon-pencil" style="color:green"></i>
                                            </a> &nbsp;&nbsp;
                                            <a href="{{ route("admin.option.contact.delete",$row->id) }}" title="Hapus" class="hapus">
            ...
            $(".datatable").DataTable({
                ...
                buttons: [
                {
                    ...
                    action: function (e, dt, node, config){
                        window.location.href = "{{ route("admin.option.contact.create") }}";
                    }
                }
                ],
            });

                        ...
                        <table class="table table-striped table-bordered datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="500">Divisi</th>
                                    <th class="text-center" width="500">Jabatan</th>
                                    <th class="text-center" width="500">Alamat</th>
                                    <th class="text-center" width="500">Telepon</th>
                                    <th class="text-center" width="500">Tanggal Dibuat</th>
                            ...
                            <tbody>
                                @foreach ($result as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $row->jabatan->nama_jabatan }}</td>
                                        <td class="text-center">{{ $row->divisi->nama_divisi }}</td>
